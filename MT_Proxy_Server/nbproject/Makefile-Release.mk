...
${OBJECTDIR}/CacheEntry.o: CacheEntry.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CacheEntry.o CacheEntry.cpp
...
${OBJECTDIR}/libs/CondVar/CondVar.o: libs/CondVar/CondVar.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/CondVar/CondVar.o libs/CondVar/CondVar.cpp

${OBJECTDIR}/libs/HTTPURIParser/HTTPURIParser.o: libs/HTTPURIParser/HTTPURIParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/libs/HTTPURIParser
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/HTTPURIParser/HTTPURIParser.o libs/HTTPURIParser/HTTPURIParser.cpp

${OBJECTDIR}/libs/Logger/Logger.o: libs/Logger/Logger.cpp 
	${MKDIR} -p ${OBJECTDIR}/libs/Logger
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/Logger/Logger.o libs/Logger/Logger.cpp

${OBJECTDIR}/libs/Mutex/Mutex.o: libs/Mutex/Mutex.cpp 
	${MKDIR} -p ${OBJECTDIR}/libs/Mutex
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/Mutex/Mutex.o libs/Mutex/Mutex.cpp

${OBJECTDIR}/libs/TCPSocket/TCPSocket.o: libs/TCPSocket/TCPSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/libs/TCPSocket
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/TCPSocket/TCPSocket.o libs/TCPSocket/TCPSocket.cpp

${OBJECTDIR}/libs/Thread/Thread.o: libs/Thread/Thread.cpp 
	${MKDIR} -p ${OBJECTDIR}/libs/Thread
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libs/Thread/Thread.o libs/Thread/Thread.cpp
